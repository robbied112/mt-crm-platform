/**
 * Shared pipeline module — parsing and transform functions used by both
 * the CLI ingest script and the scheduled Cloud Sync function.
 *
 * All functions are pure (no Firebase/Firestore dependencies).
 */
