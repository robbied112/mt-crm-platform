...
const STRIPE_SECRET = functions.config().stripe?.webhook_secret || process.env.STRIPE_WEBHOOK_SECRET || "";
...
exports.stripeWebhook = functions.https.onRequest(async (req, res) => {
  ...
  if (STRIPE_SECRET) {
    ...
    try {
      event = stripe.webhooks.constructEvent(req.rawBody, sig, STRIPE_SECRET);
    } catch (err) {
