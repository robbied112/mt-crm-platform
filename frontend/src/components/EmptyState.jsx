...
const ILLUSTRATIONS = {
  depletions: (
    <svg width="120" height="80" viewBox="0 0 120 80" fill="none">
      <rect x="10" y="50" width="12" height="20" rx="2" fill="#99f6e4" />
      <rect x="28" y="35" width="12" height="35" rx="2" fill="#5eead4" />
      <rect x="46" y="20" width="12" height="50" rx="2" fill="#14b8a6" />
      <rect x="64" y="40" width="12" height="30" rx="2" fill="#5eead4" />
      <rect x="82" y="15" width="12" height="55" rx="2" fill="#0d9488" />
      <rect x="100" y="25" width="12" height="45" rx="2" fill="#0f766e" />
      <path d="M16 48L34 33L52 18L70 38L88 13L106 23" stroke="#0f766e" strokeWidth="2" strokeDasharray="4 2" opacity="0.5" />
    </svg>
  ),
  distributors: (
    <svg width="120" height="80" viewBox="0 0 120 80" fill="none">
      <rect x="5" y="10" width="50" height="60" rx="4" fill="#f0fdfa" stroke="#99f6e4" strokeWidth="1.5" />
      <rect x="15" y="22" width="30" height="3" rx="1.5" fill="#5eead4" />
      <rect x="15" y="30" width="22" height="3" rx="1.5" fill="#99f6e4" />
      <rect x="15" y="38" width="26" height="3" rx="1.5" fill="#5eead4" />
      <rect x="65" y="10" width="50" height="60" rx="4" fill="#f0fdfa" stroke="#99f6e4" strokeWidth="1.5" />
      <circle cx="90" cy="35" r="12" fill="#ccfbf1" stroke="#14b8a6" strokeWidth="1.5" />
      <path d="M85 35l3 3 7-7" stroke="#0f766e" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  ),
  inventory: (
    <svg width="120" height="80" viewBox="0 0 120 80" fill="none">
      <rect x="20" y="15" width="80" height="50" rx="4" fill="#f0fdfa" stroke="#99f6e4" strokeWidth="1.5" />
      <rect x="30" y="25" width="24" height="14" rx="2" fill="#ccfbf1" />
      <rect x="60" y="25" width="24" height="14" rx="2" fill="#99f6e4" />
      <rect x="30" y="45" width="24" height="14" rx="2" fill="#5eead4" />
      <rect x="60" y="45" width="24" height="14" rx="2" fill="#ccfbf1" />
      <path d="M94 20l8-6v52l-8-6" stroke="#14b8a6" strokeWidth="1.5" strokeLinecap="round" />
    </svg>
  ),
  accounts: (
    <svg width="120" height="80" viewBox="0 0 120 80" fill="none">
      <circle cx="35" cy="30" r="12" fill="#ccfbf1" stroke="#14b8a6" strokeWidth="1.5" />
      <circle cx="60" cy="25" r="15" fill="#99f6e4" stroke="#0d9488" strokeWidth="1.5" />
      <circle cx="85" cy="32" r="10" fill="#ccfbf1" stroke="#14b8a6" strokeWidth="1.5" />
      <path d="M20 65c0-8 7-14 15-14s15 6 15 14" stroke="#5eead4" strokeWidth="1.5" />
      <path d="M40 60c0-10 9-18 20-18s20 8 20 18" stroke="#0d9488" strokeWidth="1.5" />
      <path d="M68 63c0-7 7-12 17-12s17 5 17 12" stroke="#5eead4" strokeWidth="1.5" />
    </svg>
  ),
  opportunities: (
    <svg width="120" height="80" viewBox="0 0 120 80" fill="none">
      <path d="M60 8l7 14 15.5 2.3-11.2 10.9 2.7 15.3L60 43.5l-14 7.5 2.7-15.3L37.5 24.3 53 22 60 8z" fill="#ccfbf1" stroke="#14b8a6" strokeWidth="1.5" />
      <path d="M30 65h60" stroke="#99f6e4" strokeWidth="2" strokeLinecap="round" />
      <path d="M40 72h40" stroke="#ccfbf1" strokeWidth="2" strokeLinecap="round" />
    </svg>
  ),
  reorder: (
    <svg width="120" height="80" viewBox="0 0 120 80" fill="none">
      <circle cx="60" cy="40" r="28" fill="#f0fdfa" stroke="#99f6e4" strokeWidth="1.5" />
      <path d="M60 20v20l12 8" stroke="#0f766e" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M85 25l5-8M90 45h10M82 60l7 5" stroke="#14b8a6" strokeWidth="1.5" strokeLinecap="round" />
    </svg>
  ),
  pipeline: (
    <svg width="120" height="80" viewBox="0 0 120 80" fill="none">
      <path d="M10 15h100l-15 25 15 25H10l15-25L10 15z" fill="#f0fdfa" stroke="#99f6e4" strokeWidth="1.5" />
      <path d="M25 25h70" stroke="#ccfbf1" strokeWidth="8" strokeLinecap="round" />
      <path d="M30 40h55" stroke="#99f6e4" strokeWidth="8" strokeLinecap="round" />
      <path d="M35 55h35" stroke="#5eead4" strokeWidth="8" strokeLinecap="round" />
    </svg>
  ),
  welcome: (
    <svg width="140" height="100" viewBox="0 0 140 100" fill="none">
      <rect x="10" y="10" width="120" height="80" rx="8" fill="#f0fdfa" stroke="#99f6e4" strokeWidth="1.5" />
      <rect x="22" y="25" width="40" height="25" rx="4" fill="#ccfbf1" />
      <rect x="22" y="56" width="40" height="25" rx="4" fill="#99f6e4" />
      <rect x="70" y="25" width="48" height="56" rx="4" fill="#5eead4" />
      <circle cx="94" cy="48" r="10" fill="#0f766e" opacity="0.3" />
          ...
          {config.features.map((feature) => (
            <div key={feature} className="empty-state__feature">
              <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
                <circle cx="7" cy="7" r="6" fill="#ccfbf1" stroke="#0f766e" strokeWidth="1" />
                <path d="M4.5 7l2 2 3.5-3.5" stroke="#0f766e" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
              <span>{feature}</span>
            </div>
          ))}
...
export function WelcomeState() {
  ...
  return (
    <div className="empty-state empty-state--welcome">
      ...
      <h2 className="empty-state__title">Welcome to Sidekick BI</h2>
