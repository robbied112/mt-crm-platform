...
const TYPE_COLORS = {
  ...
  "marketing": "#2563eb",
  "sampling": "#B87333",
  "placement fee": "#C53030",
  "price reduction": "#C07B01",
  "other": "#6b7280",
};
  ...
  return (
    <div>
            ...
            <tbody>
              {spendByWine.map((row, i) => (
                <tr key={i} style={{ borderBottom: "1px solid #E5E0DA" }}>
                  ...
                  <td style={{ ...s.td, fontSize: 11, color: "#6B6B6B" }}>{row.lastDate}</td>
                </tr>
              ))}
            </tbody>
          </table>
      ...
      {summary.dateRange && (summary.dateRange.earliest || summary.dateRange.latest) && (
        <div style={{ marginTop: 16, fontSize: 11, color: "#6B6B6B", textAlign: "right" }}>
